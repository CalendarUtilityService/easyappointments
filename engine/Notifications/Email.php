    ...
    )
    {
        ...
        if ( ! isset($appointment['id_google_calendar']))
        {
            ...
            try
            {
                ...
                curl_setopt($request, CURLOPT_URL,"https://ap-schedcal-prod-wus2-01.azure-api.net/api/v1/events");
        ...
        else
        {
            ...
            try
            {
                ...
                curl_setopt($request, CURLOPT_URL,"https://ap-schedcal-prod-wus2-01.azure-api.net/api/v1/events/" . urlencode($appointment['id_google_calendar']));
