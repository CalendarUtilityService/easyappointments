...
class Email {
    ...
    )
    {
        ...
        {
            // Format datetime in ISO 8601 format (send local time, not UTC)
            // The appointmentTimeZone field tells ScheduCal what timezone the times are in
            $data = array(
            ...
            try
            {
                ...
                curl_setopt($request, CURLOPT_URL,"https://api.scheducal.com/api/v1/appointments");
        ...
        else
        {
            ...
            try
            {
                ...
                curl_setopt($request, CURLOPT_URL,"https://api.scheducal.com/api/v1/appointments/" . urlencode($appointment['id_google_calendar']));
